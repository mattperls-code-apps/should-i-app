...
const Sign = ({ navigation }) => {
    ...
    return (
        <StackContainer navigation={navigation} header>
            ...
            <View style={{ width: "100%", paddingTop: 3.5 * screen.height, paddingBottom: 5 * screen.height + screen.bottom, paddingHorizontal: 30, backgroundColor: colors.extraDarkPurple }}>
